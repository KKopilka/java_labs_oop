...
public class Tricorn extends FractalGenerator {
     ...
     * комплексной плоскости для конкретного фрактала Значения x и y будут равны -2
     * и -2 соответственно, а ширина и высота будут равны 4.
     * 
    ...
    public int numIterations(double x, double y) {
        ...
        /*
         * Функция для фрактала Мандельброта имеет вид: Zn = Zn-1^2 + c, где Zn-1 -
         * комплексное сопряженное число, где все значения — это комплексные числа
         * (z_real, z_imaginary), Z0 = 0, и с - определенная точка фрактала, которую мы
         * отображаем на экране. Сравнение будет проводиться до тех пор, пока квадрат
         * числа z по модулю не станет больше 2^2.
         */
